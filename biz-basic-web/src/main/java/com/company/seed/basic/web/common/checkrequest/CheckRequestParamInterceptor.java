package com.company.seed.basic.web.common.checkrequest;
...
import com.company.seed.basic.web.common.checkrequest.annotation.CheckRequestParamAnnotation;
import com.company.seed.basic.web.common.checkrequest.exception.CheckIllegalException;
import com.company.seed.basic.web.common.checkrequest.policy.*;
			...
			if(!result.isValid()){
				switch (ap.getDealType()){
					case REPLACE:
						...
						break;
					case JSON:
						printJsonMsg(response, JsonCommonCodeEnum.E0006,null);
						return false;
					case ALERT:
...
//		return ap;
	...
	private CheckResult doCheck(String paramValue, List<BaseCheckPolicy> policyList) {
		...
		if(!CommonStringUtil.isEmpty(paramValue)){

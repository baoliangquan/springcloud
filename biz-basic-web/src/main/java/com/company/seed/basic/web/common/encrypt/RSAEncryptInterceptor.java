package com.company.seed.basic.web.common.encrypt;

import com.company.seed.basic.web.bean.JsonCommonCodeEnum;
import com.company.seed.basic.web.common.encrypt.annotation.CheckRSAEncryptAnnotation;
import com.company.seed.basic.web.common.encrypt.annotation.InitRSAEncryptAnnotation;
import com.company.seed.basic.web.common.encrypt.exception.RSAEncryptException;
...
public class RSAEncryptInterceptor extends ZBaseInterceptorAdapter {
	...
	private boolean refused(HttpServletResponse response,CheckRSAEncryptAnnotation annotation) throws Exception {
		switch (annotation.dealType()){
			case JSON:
				printJsonMsg(response, JsonCommonCodeEnum.E0010,null);
				return false;
			case ALERT:

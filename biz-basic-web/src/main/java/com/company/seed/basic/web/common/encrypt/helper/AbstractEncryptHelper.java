...
public abstract class AbstractEncryptHelper {
     ...
     */
    public CheckResult rsaCheck(String sign, Object o, String key, boolean onlyMD5){
        try {
     ...
     * @param onlyMD5 如果true，则只校验MD5签名
     */
    public CheckResult rsaCheck(String sign,Map<String,String> map,String key,boolean onlyMD5){
    ...
    protected abstract CheckResult checkSign(String sign, String paramMD5,String key,boolean onlyMD5);
}

...
import com.company.seed.module.dao.manager.AuthorityDao;
import com.company.seed.module.model.manager.AuthorityLeafModel;
import com.company.seed.module.model.manager.AuthorityNodeModel;
...
import com.company.seed.module.model.manager.enums.ManagerAuthType;
 ...
 */
@Repository
public class AuthorityDaoMysqlImpl extends BaseDaoImpl implements AuthorityDao {
    private static String SQL_PREFIX = "com.company.seed.module.dao.manager.AuthorityDao.";

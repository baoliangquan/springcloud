package com.company.seed.module.dao.user.impl;
 ...
 */
@Repository
public class UserDaoMysqlImpl extends BaseDaoImpl implements UserDao {
	private static String SQL_PREFIX = "com.company.seed.module.dao.user.UserDao.";

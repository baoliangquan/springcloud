...
import com.company.cloud.base.common.CacheKeyType;
...
public class RedisCacheImpl implements RedisCache {
	...
	private String wrapKey(CacheKeyType cacheTypeEnum, String key) {
		if (CacheBaseKey.SESSION.getCacheKey().equals(cacheTypeEnum.getCacheKey())) {
			return key;
		}
		StringBuilder keyBuilder = new StringBuilder();
		keyBuilder.append(env.getProperty("spring.application.name")).append(":")
				.append(ContextHolder.getDataSource().name()).append(":")
				.append(cacheTypeEnum.getCacheKey()).append(":").append(key);
